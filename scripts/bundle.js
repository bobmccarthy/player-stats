...
},{"../models/QuarterbackModel":6,"backbone":1}],5:[function(require,module,exports){
'use strict';
...
$(document).ready(function () {
	...
	function getQBModelRow(qbModel) {
		...
		$row.append($('<td />', { text: qbModel.get('name', 'id') })).append($('<td />', { text: qbModel.get('team') })).append($('<td />', { text: qbModel.get('points') })).append($('<td />', { text: qbModel.get('attempts') })).append($('<td />', { text: qbModel.get('completions') })).append($('<td />', { text: qbModel.get('yards') })).append($('<td />', { text: qbModel.get('touchdowns') })).append($('<td />', { text: qbModel.get('interceptions') })).append($('<td />', { text: qbModel.get('sacks') })).append($('<td />', { text: qbModel.get('longestCompletion') })).append($('<td />', { text: qbModel.yardsPerAttempt() }));
...
},{"./collections/QuarterbackCollection":4,"./models/QuarterbackModel":6,"jquery":3}],6:[function(require,module,exports){
'use strict';
var Backbone = require('backbone');
...
module.exports = Backbone.Model.extend({
	...
	yardsPerAttempt: function yardsPerAttempt() {
		return this.get('yards') / this.get('attempts');
	},
	addAttempt: function addAttempt(type, yards) {
		type = type.toLowerCase();
